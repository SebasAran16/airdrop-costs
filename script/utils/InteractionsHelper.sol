...
contract InteractionsHelper is AirdropUtils {
    ...
    function getETHAirdropData()
        public
        view
        returns (uint256[] memory airdropAmounts, address[] memory recipientAddresses, uint256 totalAirdropAmounts)
    {
        string memory filePath =
            string.concat(AIRDROP_FOLDER_PATH, ETH_AIRDROP_FOLDER, AIRDROP_DATA_FILE, JSON_EXTENSION);
